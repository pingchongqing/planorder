<template lang="html">
  <div>
    ...
    <el-table :data="currentData" ref="singleTable" highlight-current-row @current-change="handleCurrentChange">
...
export default {
  ...
  methods: {
    ...
    getCurrentData(data) {
      ...
      this.total = (data ? data.length : null) || this.gridData.length
    },
